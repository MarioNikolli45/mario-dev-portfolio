                    ...
                    <li>
                        <a href="#contact" className="group">
                            ...
                            <div className="relative">
                                <div className="absolute w-2/3 h-1 transistion-all duration-300 ease-out bg-orange-400 rounded-full group-hover:w-full"></div>
                                <div className="mt-1 absolute w-1/3 h-1 transistion-all duration-300 ease-out bg-orange-600 rounded-full group-hover:w-full"></div>
                            </div>
                        </a>
                    </li>
                </ul>
