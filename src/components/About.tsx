                ...
                <div className=" w-full col-span-5 relative bg-white/10 backdrop-blur-lg border border-white/20 rounded-xl overflow-hidden">
                    ...
                    <div className="flex flex-row p-6">
                        ...
                        <div className="flex flex-col mt-4">
                            ...
                            <p className="text-lg text-white/70 mt-2">Studied at IEK AKMI and currently at the University of East London, refining my skills as a full-stack developer.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
                    <div className="flex flex-row p-6">
                        ...
                        <div className="flex flex-col mt-4">
                            ...
                            <p className="text-lg text-white/70 mt-2">I have a diverse portfolio of projects and also work experience</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-orange-400 via-purple-700 to-orange-800 opacity-30 animate-gradient-xy"></div>
                    <div className="flex flex-row p-6">
                        ...
                        <div className="flex flex-col mt-4">
                            ...
                            <p className="text-lg text-white/70 mt-2">Skilled in React, Node.js, Express, and databases, building responsive and scalable applications.</p>
                        </div>
                    </div>
                </div>
